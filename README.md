...
- SQLite data release: <https://github.com/YoriJP/yori-dict/releases/tag/data-2026-08-04.1>
...
- Traditional Chinese coverage is partial but broad for common lookup. The
  `data-2026-08-04.1` release covers 77,863 zh-TW senses, including 19.60% of
...
```sh
curl -LO https://github.com/YoriJP/yori-dict/releases/download/data-2026-08-04.1/yori-dict-2026-08-04.1.sqlite.gz
curl -LO https://github.com/YoriJP/yori-dict/releases/download/data-2026-08-04.1/yori-dict-2026-08-04.1.sqlite.gz.sha256
shasum -a 256 -c yori-dict-2026-08-04.1.sqlite.gz.sha256
gunzip yori-dict-2026-08-04.1.sqlite.gz
```

Release manifest:

```sh
curl -LO https://github.com/YoriJP/yori-dict/releases/download/data-2026-08-04.1/yori-dict-2026-08-04.1.json
```

The `data-2026-08-04.1` release contains:
...
bun run scripts/package-release.ts --version 2026-08-04.1
```
